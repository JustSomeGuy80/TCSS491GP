...
class Player {
    static Objectives = [
        "Breacher Delta, are you there? Come in, Delta!\n\n...\n\nAh, you're finally awake. Here's the situation: " +
            ...
            "Quite frankly, it's a miracle you're alive. According to our scans, the cross-dimensional warp-drive is somewhere nearby, " +
            ...
            "another suit piece below you, try heading down about 35 meters.\n\nGodspeed, Breacher.",
        ...
        "That's the grappling hook. You can use it swing your way out of that pit, but again, it doesn't help you reach the warp-drive. " +
            "We're picking up one last scan. This should be the last missing piece before the warp-drive itself. " +
            "It's above and to the right of the location you first woke up at. Good luck, Delta.",
        "There it is. The blink-gate generator. With enough velocity, this device will allow you to teleport through thin walls. " +
            "This should be all you need to recover the cross-dimensional warp-drive. Its signal was strongest when you were in that temple, " +
            "So it's worth checking that area to see if your new equipment can be of use. \n\nWe look forward to your return. \nGodspeed, Breacher.",
    ];
